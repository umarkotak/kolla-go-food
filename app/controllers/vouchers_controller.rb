class VouchersController < ApplicationController
  ...
  def index
    ...
    # @vouchers = Voucher.by_letter(params[:letter])
    @vouchers = params[:letter].nil? ? Voucher.all : Voucher.by_letter(params[:letter])
  end
  ...
  private
    ...
    def voucher_params
      params.require(:voucher).permit(:kode, :valid_from, :valid_through, :amount, :unit, :max_amount)
    end
end
